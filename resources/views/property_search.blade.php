...
<section>
                            ...
                            <div class="search-form">
                                ...
                                <div class="form-horizontal">
                                    <div class="row">
                                     <div class="form-section col-md-2">
                                        <label>Keyword</label>
                                        <input class="form-control" placeholder="Rumah, Apartemen" id="keyword" name="keyword" value="{{ Request::get('keyword') }}">
                                    </div>
                                    <div class="form-section col-md-2">
                                        <label>Location</label>
                                        <input class="form-control" placeholder="Location, City" id="location" name="location" value="{{ Request::get('location') }}">
                                    </div>
                                    <div class="form-section col-md-2">
                                ...
                                <div class="row">
                                   <div class="form-section col-md-2">
                                    ...
                                    <input class="form-control" placeholder="Eg : 100000" id="land" name="land" value="{{ Request::get('land') }}">
                                </div>
                                <div class="form-section col-md-2">
                                    <label>Building Size M<sup>2</sup></label>
                                    <input class="form-control" placeholder="Eg : 100000" id="building" name="building" value="{{ Request::get('building') }}">
                                </div>
                                <div class="form-section col-md-2">
    ...
    <div class="row">
        ...
        @else
        <ul class="filter-list">
            <li class="col-md-12 mrgb5x col-sm-4 text-center" style="cursor: pointer; padding-right: 0px;">
                    DATA NOT FOUND
            </li>
        </ul>
        @endif
