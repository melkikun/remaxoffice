    ...
    <div class="container-fluid">
      <div id="owl-demo">
        ...
        <div class="item">
          ...
          <img src="https://www.remax.co.id/prodigy/papi/{{$linkImg['filePreview']}}" alt="#">
        </div>
        @php
          ...
          <a class="btn btn-social-icon btn-facebook"  href="https://www.facebook.com/sharer/sharer.php?u={{ url('property') }}/{{$property['data'][0]['listUrl']}}" target="_blank">
            ...
            <div class="description-text col-md-4" id="property-list-suggest">
              ...
              <div class="property-block-small">
                <a href="{{ url('property') }}/{{$suggest['listUrl']}}">
                  @php
                  ...
                  <div class="detail">
                    <p class="detail-p">{{$suggest['listTitle']}}</p> 
                    <p class="team-color detail-p">{{$suggest['listStreetName']}}</p> 
                    <p class="detail-p">
